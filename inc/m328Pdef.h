...
#define MCUSR   (*(volatile uint8_t *)0x34)
#define SMCR    (*(volatile uint8_t *)0x33)
#define ACSR    (*(volatile uint8_t *)0x30)
#define SPDR    (*(volatile uint8_t *)0x2e)
#define SPSR    (*(volatile uint8_t *)0x2d)
#define SPCR    (*(volatile uint8_t *)0x2c)
